...
class DocGenerator:
    def __init__(self, model_name="deepseek-coder:1.3b", temperature=0.5, top_p=0.95, max_tokens=4096):
        self.model = LLMModel(
    ...
    def create_prompt(self, code: str, language: str) -> str:
        ...
        """
        prompt = f"""You are an expert software engineer and technical documentation writer of all programming language.
